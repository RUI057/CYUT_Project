#!/bin/bash
# Mac 專用：雙擊這個檔案就會開始訓練。
# 若雙擊沒反應，先在終端機執行一次：chmod +x "開始訓練.command"

cd "$(dirname "$0")" || exit 1

echo "================================================"
echo "  手語辨識模型　一鍵訓練 (Mac)"
echo "================================================"

has_pkgs() { "$1" -c "import numpy, torch, sklearn" >/dev/null 2>&1; }
